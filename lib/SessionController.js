	...
	self.open = function(filename) {
		...
		var bind = function() {
			...
			self.dbus.on('ClientAppeared', function() {
				...
				logger.info('Client `' + clientName + '` came online');
			...
			self.dbus.on('ClientDisappeared', function() {
				...
				logger.info('Client `' + clientName + '` went offline');
			...
			self.dbus.on('PortAppeared', function() {
				...
				logger.info('Port `' + clientName + ':' + portName + '` came online');
			...
			self.dbus.on('PortDisappeared', function() {
				...
				logger.info('Port `' + clientName + ':' + portName + '` went offline');
...
module.exports.createSessionController = function(service, logger) {
	return new SessionController(service, logger);
};