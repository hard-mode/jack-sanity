...
module.exports.Container = require('./Container').Container;
module.exports.createContainer = require('./Container').createContainer;

module.exports.ContainerController = require('./ContainerController').ContainerController;
module.exports.createContainerController = require('./ContainerController').createContainerController;
...
module.exports.Sandbox = require('./Sandbox').Sandbox;
module.exports.createSandbox = require('./Sandbox').createSandbox;
